	...
	<xsl:template match="/root">
		...
		<html>
			<head>
				...
				<link rel="stylesheet" href="/static/css/modern/global.css?v6.3" type="text/css" />
				...
				<script language="Javascript" type="text/javascript" src="/static/js/modern.js?v6.3"><xsl:text> </xsl:text></script>
				<script language="Javascript" type="text/javascript" src="/static/js/machichara/complex.js?v1"><xsl:text> </xsl:text></script>
				<script language="Javascript" type="text/javascript" src="/static/js/machichara/simple.js?v6.3"><xsl:text> </xsl:text></script>
