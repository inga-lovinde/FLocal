...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/1999/xhtml">
	...
	<xsl:template name="specificTitle">Изменение аватарки</xsl:template>
			...
			<tr>
				<td>
					<table cellpadding="3" cellspacing="1" width="100%" class="tableborders">
						<tr>
							<td class="tdheader">
								<xsl:text>Изменение аватарки</xsl:text>
							</td> 
						</tr>
					</table>
				</td>
			...
			<tr>
				<td>
					<table cellpadding="3" cellspacing="1" width="100%" class="tableborders">
						<tr> 
							<td class="lighttable"> 
								<p>Новая аватарка была успешно установлена</p>
								<p align="center">
									<xsl:text>[&#8592;] </xsl:text>
									...
									<a id="actionLink_right">
										...
										<xsl:text>Просмотреть аватарку</xsl:text>
									</a>
									<xsl:text> [&#8594;]</xsl:text>
								</p>
